...
export function SiteFooter() {
  return (
    <footer className="border-t border-border">
      <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-5 px-5 py-9 text-sm text-muted-foreground sm:flex-row sm:items-center">
        <div>
          <p className="text-foreground/80">
            Saltworks — built as a learning resource.
          </p>
          <p className="mt-1 label-spec">
            Every demo runs in your browser · crypto.subtle · nothing leaves the
            page
          </p>
        </div>
